...
function OpenedColor(text,ColourDisplay,Action,def)
	...
	TEMPLATETITLE20202.Font = Enum.Font.Code
...
LABEL2.Text = "Beta Build / V 3.5.5"
...
UPPERLABEL.ZIndex = 3
UPPERLABEL.Font = Enum.Font.Code
...
function library:AddWindow(text)
	...
	TEMPLATE_TEXT.Font = Enum.Font.Code
		...
		function inside:AddToggle(Text,Enabled,keybind,Callback)
			...
			local function Update()
				if activated == false then
					TweenService:Create(color , TweenInfo.new(0.26, Enum.EasingStyle.Quad , Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromRGB(247, 133, 197)}):Play()
			...
			Interactive.Font = Enum.Font.Code
			Interactive.Text = ""
