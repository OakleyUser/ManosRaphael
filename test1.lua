...
function OpenedColor(text,ColourDisplay,Action,def)
	...
	TEMPLATETITLE20202.Font = Enum.Font.Inter
...
UPPERLABEL.ZIndex = 3
UPPERLABEL.Font = Enum.Font.Inter
...
function library:AddWindow(text)
	...
	TEMPLATE_TEXT.Font = Enum.Font.Inter
	...
	function sec:AddSection(Texto,side)
		...
		function inside:AddLabel(Text)
			...
			TextLabel.ZIndex = 15
			TextLabel.Font = Enum.Font.Inter
			TextLabel.Text = Text
		...
		function inside:AddColorPallete(Text,Color,Action)
			...
			OPENCLOSE.Font = Enum.Font.Inter
			OPENCLOSE.Text = Text
		...
		function inside:AddDropdown(Text,tbl,sel,Action)
			...
			TextLabel_2.Font = Enum.Font.Inter
			TextLabel_2.Text = "+"
			...
			for i,v in pairs(tbl) do
				...
				TextLabel_3.Font = Enum.Font.Inter
				TextLabel_3.Text = v
