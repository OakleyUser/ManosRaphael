...
function OpenedColor(text,ColourDisplay,Action,def)
	...
	BG.BorderColor3 = Color3.fromRGB(247, 133, 197)
	...
	Upper.BorderColor3 = Color3.fromRGB(247, 133, 197)
	...
	TEMPLATETITLE20202.Font = Enum.Font.fromId(12187365364)
	...
	linedecoupper.BackgroundColor3 = Color3.fromRGB(247, 133, 197)
	linedecoupper.BorderColor3 = Color3.fromRGB(247, 133, 197)
...
DOWNER.BorderColor3 = Color3.fromRGB(247, 133, 197)
...
linedecoDOWNER.BackgroundColor3 = Color3.fromRGB(247, 133, 197)
linedecoDOWNER.BorderColor3 = Color3.fromRGB(247, 133, 197)
...
UPPERLABEL.ZIndex = 3
UPPERLABEL.Font = Enum.Font.fromId(12187365364)
...
function library:AddWatermark(Text)
	...
	obj4.Font = Enum.Font.fromId(12187365364)
	obj4.Text = Text
...
function library:AddWindow(text)
	...
	TEMPLATE_TEXT.Font = Enum.Font.fromId(12187365364)
	...
	function sec:AddSection(Texto,side)
		...
		F_line.BackgroundColor3 = Color3.fromRGB(247, 133, 197)
		F_line.BorderColor3 = Color3.fromRGB(247, 133, 197)
		...
		A_label.ZIndex = 3
		A_label.Font = Enum.Font.fromId(12187365364)
		A_label.Text = Texto
		...
		function inside:AddSlider(Text,Max,Min,def,Action)
			...
			obj2.ZIndex = 21
			obj2.Font = Enum.Font.fromId(12187365364)
			obj2.Text = Text
		...
		function inside:AddLabel(Text)
			...
			TextLabel.ZIndex = 15
			TextLabel.Font = Enum.Font.fromId(12187365364)
			TextLabel.Text = Text
		...
		function inside:AddColorPallete(Text,Color,Action)
			...
			OPENCLOSE.Font = Enum.Font.fromId(12187365364)
			OPENCLOSE.Text = Text
		...
		function inside:AddDropdown(Text,tbl,sel,Action)
			...
			Toggle.Font = Enum.Font.fromId(12187365364)
			Toggle.Text = "  "
			...
			TextLabel_2.Font = Enum.Font.fromId(12187365364)
			TextLabel_2.Text = "+"
			...
			for i,v in pairs(tbl) do
				...
				OPTION.Font = Enum.Font.fromId(12187365364)
				OPTION.Text = ''
				...
				TextLabel_3.Font = Enum.Font.fromId(12187365364)
				TextLabel_3.Text = v
