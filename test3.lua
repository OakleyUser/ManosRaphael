...
function OpenedColor(text,ColourDisplay,Action,def)
	...
	TEMPLATETITLE20202.Font = Font.fromId(12187365364)
...
UPPERLABEL.ZIndex = 3
UPPERLABEL.Font = Font.fromId(12187365364)
...
function library:AddWatermark(Text)
	...
	obj4.Font = Font.fromId(12187365364)
	obj4.Text = Text
...
function library:AddWindow(text)
	...
	TEMPLATE_TEXT.Font = Font.fromId(12187365364)
	...
	function sec:AddSection(Texto,side)
		...
		A_label.ZIndex = 3
		A_label.Font = Font.fromId(12187365364)
		A_label.Text = Texto
		...
		function inside:AddSlider(Text,Max,Min,def,Action)
			...
			obj2.ZIndex = 21
			obj2.Font = Font.fromId(12187365364)
			obj2.Text = Text
		...
		function inside:AddLabel(Text)
			...
			TextLabel.ZIndex = 15
			TextLabel.Font = Font.fromId(12187365364)
			TextLabel.Text = Text
		...
		function inside:AddColorPallete(Text,Color,Action)
			...
			OPENCLOSE.Font = Font.fromId(12187365364)
			OPENCLOSE.Text = Text
		...
		function inside:AddDropdown(Text,tbl,sel,Action)
			...
			Toggle.Font = Font.fromId(12187365364)
			Toggle.Text = "  "
			...
			TextLabel_2.Font = Font.fromId(12187365364)
			TextLabel_2.Text = "+"
			...
			for i,v in pairs(tbl) do
				...
				OPTION.Font = Font.fromId(12187365364)
				OPTION.Text = ''
				...
				TextLabel_3.Font = Font.fromId(12187365364)
				TextLabel_3.Text = v
